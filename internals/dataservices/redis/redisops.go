...
func (r *RedisStore) WriteKV(ctx context.Context, key, value string) (interface{}, error) {
	...
	if err != nil {
		return dmutils.EMPTYSTR, dmerrors.DMError(ErrRedisWrite, err)
	}
	return res, nil
}
...
func (r *RedisStore) ReadKV(ctx context.Context, key string) (interface{}, error) {
	...
	if err != nil {
		return dmutils.EMPTYSTR, dmerrors.DMError(ErrRedisRead, err)
	}
	return res, nil
}
...
func (r *RedisStore) DeleteKey(ctx context.Context, key string) (interface{}, error) {
	...
	if err != nil {
		return dmutils.EMPTYSTR, dmerrors.DMError(ErrRedisDelete, err)
	}
	return res, nil
}
...
func (r *RedisStore) writeJsonData(ctx context.Context, key, path string, value interface{}) (interface{}, error) {
	...
	if result.Err() != nil {
		return dmutils.EMPTYSTR, dmerrors.DMError(ErrRedisWrite, result.Err())
	}
...
func (r *RedisStore) readJsonData(ctx context.Context, key, path string) (interface{}, error) {
	...
	if result.Err() != nil {
		return dmutils.EMPTYSTR, dmerrors.DMError(ErrRedisRead, result.Err())
	}
