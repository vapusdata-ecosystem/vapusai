...
init-env:
	...
	ifeq ($(shell uname -s),darwin)
		ifeq ($(shell uname -m),arm64)
			curl -LO https://golang.org/dl/go1.22.4.darwin-arm64.tar.gz
			tar -C /usr/local -xzf go1.22.4.darwin-arm64.tar.gz
			rm go1.22.4.darwin-arm64.tar.gz
		else ifeq ($(shell uname -m),x86_64)
			curl -LO https://golang.org/dl/go1.22.4.darwin-amd64.tar.gz
			tar -C /usr/local -xzf go1.22.4.darwin-amd64.tar.gz
			rm go1.22.4.darwin-amd64.tar.gz
